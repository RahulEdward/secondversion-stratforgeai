...
from app.shadow_account.codegen import write_run_dir
from app.shadow_account.models import (
    AttributionBreakdown,
    ShadowBacktestResult,
    ShadowProfile,
)
from app.shadow_account.storage import runs_dir
from app.agent_tools.trade_journal_parsers import parse_file, records_to_dataframe
from app.agent_tools.trade_journal_tool import pair_trades_fifo
...
def _default_run_backtest_fn():
    from app.agent_tools.backtest_tool import run_backtest
    return run_backtest
