...
from app.backtest_engine.models import EquitySnapshot, Position, TradeRecord
...
class BaseEngine(ABC):
    ...
    def run_backtest(
        ...
        if bench_ticker and bench_ticker != "auto":
            from app.backtest_engine.benchmark import resolve_benchmark
        ...
        if config.get("validation"):
            from app.backtest_engine.validation import run_validation
