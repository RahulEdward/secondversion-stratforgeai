...
from app.agent_tools.path_utils import safe_user_path
from app.shadow_account import (
...
from app.shadow_account.backtester import load_cached_result
from app.shadow_account.scanner import scan_today_signals
    ...
    def execute(self, **kwargs: Any) -> str:
        ...
        if result is None:
            ...
            try:
                ...
                from app.shadow_account.models import AttributionBreakdown, ShadowBacktestResult
